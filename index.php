		...
		<div class="container">
			...
			<div class="row">
				<?php
					...
					$table->addCol('Login', 'username');
					$table->addCol("E-mail", "email");
					$table->addCol("Connexion", "last_login");
					$table->addCol("Expiré", "expired");
			...
			<div class="row">
				<?php
					...
					$table->addColIndex('N', 'id', true, false);
					$table->addCol("Nom", "name");
					$table->addCol("Description", "description");
					$table->addCol("Code postal", "cp");
